...
namespace NSmartProxy.P2PClient
{
    class Program
    {
        ...
        private static void NetPunchListener_NatIntroductionRequest1(System.Net.IPEndPoint localEndPoint, System.Net.IPEndPoint remoteEndPoint, string token)
        {
        ...
        {
            Console.WriteLine("received:" + reader.GetString());
        }
    }
}
