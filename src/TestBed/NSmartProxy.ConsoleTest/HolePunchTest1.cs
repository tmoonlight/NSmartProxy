    ...
    class HolePunchServerTest : INatPunchListener
    {
        ...
        public void Run()
        {
            ...
            natPunchListener1.NatIntroductionSuccess += (point,  token) =>
            {
                ...
                Console.WriteLine($"NatIntroductionSuccess C1. Connecting to C2: {point}, type: , connection created: {peer != null}");
            };

            natPunchListener2.NatIntroductionSuccess += (point,  token) =>
            {
                var peer = _c2.Connect(point, ConnectionKey);
                Console.WriteLine($"NatIntroductionSuccess C2. Connecting to C1: {point}, type: , connection created: {peer != null}");
            };
